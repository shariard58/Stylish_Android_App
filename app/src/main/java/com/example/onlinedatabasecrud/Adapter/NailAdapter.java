...
public class NailAdapter extends RecyclerView.Adapter<NailAdapter.ViewHolder>
    ...
    private NailAdapter.OnItemClickListener mListener;

    public interface OnItemClickListener {
        void onItemClick(int position);
    }

    public void setOnItemClickListener(NailAdapter.OnItemClickListener listener) {
        mListener=listener;
    }


    public NailAdapter(List<ShopsInfo> list) {
        this.list = list;
    ...
    public NailAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.nail_info_list, parent, false);
        NailAdapter.ViewHolder holder = new NailAdapter.ViewHolder(view, mListener);
        return holder;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, NailAdapter.OnItemClickListener mListener) {
            super(itemView);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (NailAdapter.this.mListener != null) {
                        int position = getAdapterPosition();
                        if (position != RecyclerView.NO_POSITION) {
                            NailAdapter.this.mListener.onItemClick(position);
                        }
                    }
                }
            });
